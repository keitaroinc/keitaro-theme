		...
		<div class="row">
			...
			<div class="col-md-12 col-lg-4">
				...
				if ( ( 'POST' === $_SERVER['REQUEST_METHOD'] && isset( $_POST['submit'] ) ) && wp_verify_nonce( $_REQUEST['_wpnonce'], 'contact-form-widget' ) ) :
					...
					$attachments = array( ( isset( $_POST['attachment'] ) ) ? str_replace( "\r\n", '<br>', trim( esc_html( $_POST['attachment'] ) ) ) : '' );
...
if ( ! empty( $instance['attachment_label'] ) ) :
	...
	?>
			<div class="form-group">
				<input type="file" id="attachment" required="required" class="form-control" placeholder="Upload" value="<?php echo ( isset( $_POST['attachment'] ) ? esc_textarea( $_POST['attachment'] ) : '' ); ?>">
				<label for="attachment"><?php echo esc_html( $instance['attachment_label'] ); ?></label>
			</div>
			<?php
	...
	public function form( $instance ) {
		...
		<p>
			...
			<input class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'attachment_label' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'attachment_label' ) ); ?>" type="text" value="<?php echo esc_attr( $attachment_label ); ?>">
		</p>
		<p>
