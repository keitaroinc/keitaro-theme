...
class Keitaro_Icon_Block extends WP_Widget {
    ...
    public function form($instance) {
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('icon')); ?>"><?php esc_attr_e('Icon (Base64-encoded):', 'keitaro'); ?></label>
            <textarea id="<?php echo esc_attr($this->get_field_id('icon')); ?>" name="<?php echo esc_attr($this->get_field_name('icon')); ?>" class="widefat text" style="height: 100px"><?php echo esc_textarea($icon); ?></textarea>
        </p>
        <p style="text-align: right"><a href="https://www.base64encode.org/" target="_blank">Encode to Base64</a></p>
        <p>
