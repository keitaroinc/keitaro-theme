	...
	function custom_postimage_meta_box_func($post){
			...
			foreach($meta_keys as $meta_key){
					...
					<div class="custom_postimage_wrapper" id="<?php echo $meta_key; ?>_wrapper" style="margin-bottom:20px;">
							...
							<a class="addimage button" onclick="custom_postimage_add_image('<?php echo $meta_key; ?>');"><?php _e('add image','keitaro'); ?></a><br>
							<a class="removeimage" style="color:#a00;cursor:pointer;display: <?php echo ($image_meta_val!=''?'block':'none'); ?>" onclick="custom_postimage_remove_image('<?php echo $meta_key; ?>');"><?php _e('remove image','keitaro'); ?></a>
			...
			function custom_postimage_add_image(key){
					...
					custom_postimage_uploader = wp.media.frames.file_frame = wp.media({
							...
							button: {
									text: '<?php _e('select image','keitaro'); ?>'
							},
							multiple: false
					});
